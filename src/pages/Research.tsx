...
const milestones: Milestone[] = [
  {
    ...
    date: "Sept 12, 2023",
    status: "COMPLETED",
    detail: "Approved by PG Committee",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    date: "TBD",
    status: "PENDING",
    detail: "Awaiting data completion",
  },
  {
    id: 5,
    title: "Final Defense",
    date: "May 2026",
    status: "PENDING",
    detail: "Scheduled for Summer Session",
  },
];
      ...
      <div className="res-header">
        <div className="res-title-block">
          ...
          <p className="res-desc">
            Monitor your research milestones, track supervisor feedback, and
            manage your dissertation progress for{" "}
      ...
      <div className="res-research-grid">
        ...
        <section className="res-timeline-card">
          ...
          <div className="res-timeline">
            {milestones.map((m) => (
              <div
                key={m.id}
                className={`res-timeline-item res-timeline-item--${m.status.toLowerCase()}`}
              >
        ...
        <aside className="res-supervisor-card">
          ...
          <div className="res-recent-feedback">
            ...
            <p>
              "Excellent progress on the literature review. Please ensure
              Chapter 3 aligns with the new requirements report."
            </p>
